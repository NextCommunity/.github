...
FALLBACK_LEVELS = [
    ...
    {"level": 250, "name": "Matrix Architect", "emoji": "🧬",
     "color": "#6d28d9", "rarity": "mythic",
    ...
    {"level": 750, "name": "Cosmic Voyager", "emoji": "🪐",
     "color": "#4c1d95", "rarity": "mythic",
     "description": "Traversing the code universe."},
